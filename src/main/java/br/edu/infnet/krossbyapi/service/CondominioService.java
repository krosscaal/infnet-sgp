...
public class CondominioService implements ServiceBase<CondominioRecord, Long>{
    ...
    @Override
    public CondominioRecord buscar(Long idObjeto) throws BusinessException {
    ...
    @Override
    public CondominioRecord salvar(CondominioRecord entidade) throws BusinessException {
    ...
    @Override
    public CondominioRecord atualizar(Long idObjeto, CondominioRecord entidade) throws BusinessException {
    ...
    @Override
    public void apagar(Long idObjeto) throws BusinessException {
        Condominio condominio = this.buscarCondominioPorId(idObjeto);
