...
public class CondominioController extends ControllerBase<CondominioRecord, Long> {
    ...
    @Override
    protected ResponseEntity<CondominioRecord> acaoObter(Long id) throws BusinessException {
        return ResponseEntity.ok(service.buscar(id));
    }

    @Override
    protected ResponseEntity<List<CondominioRecord>> acaoListar() {
    ...
    @Override
    protected ResponseEntity<CondominioRecord> acaoAtualizar(Long id, CondominioRecord dto) throws BusinessException {
